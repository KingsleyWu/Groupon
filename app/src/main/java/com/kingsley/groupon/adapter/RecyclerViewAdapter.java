...
import com.kingsley.groupon.util.WrapperUtils;

/**
 * class name : Groupon
 * author : Kingsley
 * created date : on 2017/6/22 20:12
 * file change date : on 2017/6/22 20:12
 * version: 1.0
 */
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (isHeaderViewPosition(position) || isFooterViewPos(position)) {
